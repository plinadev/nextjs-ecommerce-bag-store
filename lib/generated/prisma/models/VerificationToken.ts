...
export type VerificationTokenScalarWhereWithAggregatesInput = {
  ...
  indetifier?: Prisma.StringWithAggregatesFilter<"VerificationToken"> | string
...
export type VerificationTokenUpdateInput = {
  indetifier?: Prisma.StringFieldUpdateOperationsInput | string
...
export type VerificationTokenIndetifierTokenCompoundUniqueInput = {
  indetifier: string
  token: string
}
...
export type VerificationTokenOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"indetifier" | "token" | "expires", ExtArgs["result"]["verificationToken"]>
...
export interface VerificationTokenDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
   ...
   * 
   * // Only select the `indetifier`
   * const verificationTokenWithIndetifierOnly = await prisma.verificationToken.findMany({ select: { indetifier: true } })
   * 
   */
   ...
   * })
   * 
   * // Create many VerificationTokens and only return the `indetifier`
   * const verificationTokenWithIndetifierOnly = await prisma.verificationToken.createManyAndReturn({
   *   select: { indetifier: true },
   *   data: [
   *     // ... provide data here
   *   ]
   * })
   ...
   * })
   * 
   * // Update zero or more VerificationTokens and only return the `indetifier`
   * const verificationTokenWithIndetifierOnly = await prisma.verificationToken.updateManyAndReturn({
   *   select: { indetifier: true },
   *   where: {
   *     // ... provide filter here
   *   },
...
export interface VerificationTokenFieldRefs {
  readonly indetifier: Prisma.FieldRef<"VerificationToken", 'String'>
