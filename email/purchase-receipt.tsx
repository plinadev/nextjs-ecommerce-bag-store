        ...
        <Body className="font-sans bg-white">
          <Container className="max-w-xl">
            ...
            <Section>
              <Row>
                <Column>
                  <Text className="mb-0 mr-4 text-stone-500 whitespace-nowrap text-nowrap">
                    Order ID
                  </Text>
            ...
            <Section className="border border-solid border-stone-400 rounded-lg p-4 md:p-6 my-4">
